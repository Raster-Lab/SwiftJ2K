...
Start with `AGENTS.md` and `IMPLEMENTATION.md`. The repository began as a documentation foundation; implementation is staged. Keep pull requests focused and preserve independent package consumption.
